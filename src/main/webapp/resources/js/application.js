var app = (function(){
	...
	var img = function(){return session.getImagePath('img');};
		var setContentView= function(){
			$('#header_brand').attr('src',app.img()+'/default/brand.jpg').css('height','80px').css('width','100px').css('padding-bottom','20px');
...
var user = (function(){
	...
	var setContentView=function(){
	$('#member_content_img_home').attr('src',app.img()+'/home.jpg');
	};
	var onCreate = function(){
		setContentView();
