...
<section id="grade_regist">
  ...
  <li class="list-group-item">학년:3학년</li>
	...
	<div>
	<div><label for="exampleInputEmail1">Java</label>
	<div><input type="text"  id="id" name="id" placeholder="점수입력"></div></div>
	</div> 
	
	<div><label for="exampleInputEmail1">Javascript</label>
	<div><input type="text"  id="id" name="id" placeholder="점수입력"></div></div>


	<div><label for="exampleInputEmail1">SQL</label>
	<div><input type="text"  id="id" name="id" placeholder="점수입력"></div></div>
	
	
	<div><label for="exampleInputEmail1">HTML</label>
	<div><input type="text"  id="id" name="" placeholder="점수입력"></div></div>
